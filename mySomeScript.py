...
z = v = n = 138  # Задаем переменные со множественным присвоением
print("Идентификатор переменной z = ", id(z))  # Выводим идентификатор переменной
print("Идентификатор переменной v = ", id(v))  # Выводим идентификатор переменной
print("Идентификатор переменной n = ", id(n))  # Выводим идентификатор переменной
